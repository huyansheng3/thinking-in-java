...
class SquareRotate2 extends JPanel {
...
public class RotatingSquare2 extends JFrame {
    ...
    public static void main(String[] args){
        SwingConsole.run(new RotatingSquare2(), 400, 400);
